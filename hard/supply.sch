...
U 1 1 6055E066
P 5850 3650
F 0 "C21" H 5736 3604 50  0000 R CNN
...
U 1 1 60563587
P 7850 4150
F 0 "C22" H 7735 4104 50  0000 R CNN
...
U 1 1 6056BF47
P 8400 4150
F 0 "R199" H 8470 4196 50  0000 L CNN
...
U 1 1 6056F7CE
P 8400 4650
F 0 "R200" H 8470 4696 50  0000 L CNN
...
U 1 1 60572E18
P 9000 4150
F 0 "C23" H 8885 4104 50  0000 R CNN
...
U 1 1 60574B19
P 9600 4150
F 0 "C24" H 9485 4104 50  0000 R CNN
...
U 1 1 60578BC3
P 9650 3850
F 0 "#PWR0189" H 9650 3700 50  0001 C CNN
...
U 1 1 6057B855
P 5750 3350
F 0 "#PWR0184" H 5750 3200 50  0001 C CNN
...
U 1 1 60575673
P 5850 4050
F 0 "#PWR0190" H 5850 3800 50  0001 C CNN
...
U 1 1 605811D8
P 9000 4850
F 0 "#PWR0196" H 9000 4600 50  0001 C CNN
...
U 1 1 605828FA
P 9600 4850
F 0 "#PWR0197" H 9600 4600 50  0001 C CNN
...
U 1 1 6057A1D3
P 8400 4850
F 0 "#PWR0195" H 8400 4600 50  0001 C CNN
...
F 2 "led_matrix:Connectors_SHOU-HAN_MicroXNJ" H 2600 3550 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1912111437_SHOU-HAN-MicroXNJ_C404969.pdf" H 2600 3550 50  0001 C CNN
F 4 "" H 2450 3600 50  0001 C CNN "DigiKey"
F 5 "" H 2450 3600 50  0001 C CNN "Mouser"
F 6 "C404969" H 2450 3600 50  0001 C CNN "LCSC"
F 7 "SHOU HAN" H 2450 3600 50  0001 C CNN "MF"
F 8 "MicroXNJ" H 2450 3600 50  0001 C CNN "MPN"
F 9 "SMD USB CONNECTORS ROHS" H 2450 3600 50  0001 C CNN "Description"
	1    2450 3600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 6056C9AF
P 4300 3400
F 0 "#PWR0185" H 4300 3250 50  0001 C CNN
...
U 1 1 6056D447
P 2500 4100
F 0 "#PWR0192" H 2500 3850 50  0001 C CNN
...
U 1 1 6057E614
P 3050 3800
F 0 "#PWR0186" H 3050 3550 50  0001 C CNN
...
U 1 1 6057ED88
P 3650 3800
F 0 "#PWR0187" H 3650 3550 50  0001 C CNN
...
U 1 1 614F2C5D
P 2300 4100
F 0 "#PWR0191" H 2300 3850 50  0001 C CNN
...
U 1 1 613BB852
P 4250 3800
F 0 "#PWR0188" H 4250 3550 50  0001 C CNN
...
U 1 1 613D470A
P 4250 3600
F 0 "C20" H 4135 3554 50  0000 R CNN
...
U 1 1 614F0A85
P 2250 4800
F 0 "#PWR0193" H 2250 4550 50  0001 C CNN
...
U 1 1 614EE00A
P 2650 4800
F 0 "#PWR0194" H 2650 4550 50  0001 C CNN
...
U 1 1 6056E34B
P 2450 4750
F 0 "R201" H 2520 4796 50  0000 L CNN
...
$EndComp
$Comp
L led_matrix:TPS54202DDCR DCDC1
U 1 1 605E86F2
P 6550 3300
F 0 "DCDC1" H 6550 3465 50  0000 C CNN
F 1 "TPS54202DDCR" H 6550 3374 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-6_Handsoldering" H 6550 3300 50  0001 C CNN
F 3 "https://www.ti.com/lit/ds/symlink/tps54202.pdf" H 6550 3300 50  0001 C CNN
F 4 "296-TPS54202DDCRCT-ND" H 6550 3300 50  0001 C CNN "DigiKey"
F 5 "C191884" H 6550 3300 50  0001 C CNN "LCSC"
F 6 "Texas Instruments" H 6550 3300 50  0001 C CNN "MF"
F 7 "TPS54202DDCR" H 6550 3300 50  0001 C CNN "MPN"
F 8 "IC REG BUCK ADJ 2A TSOT23-6" H 6550 3300 50  0001 C CNN "Description"
	1    6550 3300
	1    0    0    -1  
$EndComp
$EndSCHEMATC
